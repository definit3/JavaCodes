...
public class CustomerController {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/customers/{id}/{name}/{sal}", produces = "application/json")
	...
	public ResponseEntity saveCustomer(@PathVariable("id") Integer id, @PathVariable("name") String name, @PathVariable("sal") Integer sal)
	{
		...
		if (customer != null) {
			return new ResponseEntity("Customer id already exists",HttpStatus.BAD_REQUEST);
		}
